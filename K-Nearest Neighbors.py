...
The program finds the 5(n_neighbours) closest points to the new data point
Among the 5(n_neighbours) whichever category has the most points is the category assigned to the new data point
...
classifier = KNeighborsClassifier(n_neighbors = 5,        # n_neighbours = k
                                  weights='uniform',      # Equal importance is given to all the neighbours
                                  metric = 'minkowski',   # Euclidean Distance
                                  p=2)                    # Necessary for euclidean distance
