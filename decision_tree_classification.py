...
Just like in decision tree regression:
...
Summary:
  ...
  Y is predicted to belong to the category which has the most points in a pericular leaf
"""
# Importing libraries
import numpy as np
...
classifier = DecisionTreeClassifier(criterion = 'entropy') # How you want to split the data into Terminal nodes
